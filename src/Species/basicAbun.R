...
#                             "Coverage estimate for whole data", "CV for whole data", "Cut-off point",
#                             "Number of observed individuals for rare species", "Number of observed species for rare species",
#                             "Estimated sample coverage for rare species",
#                             "Estimated CV for rare species in ACE", "Estimated CV1 for rare species in ACE-1",
